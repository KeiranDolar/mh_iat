	...
	*/	
    API.addQuestionsSet('attributes7',{
        ...
        answers: [
            ...
            {text:'I slightly prefer <%= global.mentallyIllLabels %> to <%= global.mentallyHealthyLabels %>.',value:3},
            {text:'I moderately prefer <%= global.mentallyIllLabels %> to <%= global.mentallyHealthyLabels %>.',value:2},
            {text:'I strongly prefer <%= global.mentallyIllLabels %> to <%= global.mentallyHealthyLabels %>.',value:1}
        ]
    });
